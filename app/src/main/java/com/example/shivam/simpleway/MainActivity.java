...
import com.example.shivam.simpleway.data.GlobalData;
import com.example.shivam.simpleway.data.Preferences;
import com.example.shivam.simpleway.detection.AggregateLumaMotionDetection;
import com.example.shivam.simpleway.detection.IMotionDetection;
import com.example.shivam.simpleway.detection.LumaMotionDetection;
import com.example.shivam.simpleway.detection.RgbMotionDetection;
import com.example.shivam.simpleway.image.ImageProcessing;
    ...
    private SurfaceHolder.Callback surfaceCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            try {
                ...
                Log.e("PreD-surfaceCallback", "Exception in setPreviewDisplay()", t);
            }
        }
            ...
            try {
                ...
                if (img != null && detector.detect(img, width, height)) {
                    ...
                    if (now > (mReferenceTime + Preferences.PICTURE_DELAY)) {
                        ...
                        Looper.prepare();
                        ref.child("motion").child("isMOtion").setValue("True");

                        new SavePhotoTask().execute(previous, original, bitmap);

                    } else {
                        Log.i(TAG, "Not taking picture because not enough time has passed since the creation of the Surface");
                        ref.child("motion").child("isMOtion").setValue("False");
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
